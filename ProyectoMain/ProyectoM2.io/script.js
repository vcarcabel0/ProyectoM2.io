                    ...
                    <div class="col rounded-4">
                      <div class="card bg-success rounded-5">
                        ...
                        <div class="card-img-overlay">
                          ...
                          <button class="box btn btn-success" id ="${datosEvento[0].id}">Ver</button>
                    ...
                    <div class="col">
                      <div class="card bg-success text-white rounded-5">
                        ...
                        <div class="card-img-overlay">
                          ...
                          <button class="box btn btn-success" id ="${datosEvento[1].id}">Ver</button>
                    ...
                    <div class="col">
                      <div class="card bg-success text-white rounded-5">
                        ...
                        <div class="card-img-overlay">
                          ...
                          <button class="box btn btn-success" id ="${datosEvento[2].id}">Ver</button>
            ...
            <div class="col">
              <div class="card bg-success text-white rounded-5">
                ...
                <div class="card-img-overlay">
                  ...
                  <button class="box btn btn-success" id ="${evento.id}">Ver</button>
                </div>
              </div>
            </div>
              `
